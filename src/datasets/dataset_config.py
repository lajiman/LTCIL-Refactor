...
dataset_config = {
    ...
    'VGGSound_balance': {
        # 'path': '/path/to/vggsound.csv',
        # 'feature_root': '/path/to/VGGSound/features',
        'path': '/home/dal400642/Projects/AV-CIL_ICCV2023/data/vggsound.csv',
        'feature_root': '/mnt/data2/wpian/dataset/VGGSound',
        'specific': {
            ...
            # LT/balance target construction
            'gamma': 100.0,
            'mean_cap': 512,
            'nmax_policy': 'min',

            # unused in this mode but kept for consistency
            'random_seed': 101,
